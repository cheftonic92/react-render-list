...
export const GKList = PlayerList.filter((player) => player.posicion === 'Portero');
export const DEFList = PlayerList.filter((player) => player.posicion === 'Defensa');
export const MIDList = PlayerList.filter((player) => player.posicion === 'Centrocampista');
export const FWDList = PlayerList.filter((player) => player.posicion === 'Delantero');
